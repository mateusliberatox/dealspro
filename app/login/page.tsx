    ...
    <div className="flex min-h-screen items-center justify-center px-4" style={{ background: 'var(--bg)' }}>
      <div className="w-full max-w-xs space-y-7">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90"
          style={{ background: '#5865F2' }}
        >
          <svg width="18" height="18" viewBox="0 0 127.14 96.36" fill="white" xmlns="http://www.w3.org/2000/svg">
